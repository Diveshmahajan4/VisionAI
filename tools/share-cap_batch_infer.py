...
def parse_args():
    ...
    parser.add_argument("--model-name", type=str, default="Lin-Chen/ShareCaptioner")
    parser.add_argument(
        "--images-file",
        type=str,
        default="images_to_describe.json",
...
if __name__ == "__main__":
    ...
    model = AutoModelForCausalLM.from_pretrained(
        args.model_name, device_map="cuda", trust_remote_code=True
    ).eval()
