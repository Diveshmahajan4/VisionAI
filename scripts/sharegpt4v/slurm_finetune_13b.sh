...
export CKPT_PATH=checkpoints/share4v-13b_pretrained_pt-1.2m_ft-vit-l12-mlp-llm-lr-2e-5
export VIT_PATH=checkpoints/share4v-13b_pretrained_pt-1.2m_ft-vit-l12-mlp-llm-lr-2e-5/vision_tower
export SAVE_PATH=share4v-13b
