...
export CKPT_PATH=pretrained/projector/llava-v1.5-mlp2x-336px-pretrain-vicuna-13b-v1.5/mm_projector.bin
export SAVE_PATH=share4v-13b_pretrained_pt-1.2m_ft-vit-l12-mlp-llm-lr-2e-5
